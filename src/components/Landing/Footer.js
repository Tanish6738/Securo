      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <span className="text-2xl font-bold text-white">PrivacyGuard</span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Protecting your digital privacy with comprehensive monitoring, secure tools, 
              and real-time threat intelligence. Your privacy is our priority.
            </p>
          ...
          >
            <h3 className="text-white font-semibold mb-6 relative">
              Product
              <motion.div
                className="absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-blue-400 to-transparent"
                initial={{ width: 0 }}
        ...
        >
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2024 PrivacyGuard. All rights reserved. | Protecting privacy since 2024.
          </div>
